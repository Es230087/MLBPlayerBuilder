...
public class RemoteMLBPlayerInfoResource {
    ...
    String age;
    String name_display_first_last_html;
    String gender;
    String height_feet;
    String pro_debut_date;
    String death_date;
    String primary_position;
    String birth_date;
    String team_abbrev;
    String status;
    String name_display_last_first_html;
    //String throws;
    String death_city;
    String primary_position_txt;
    String high_school;
    String name_display_roster_html;
    String name_use;
    String player_id;
    String status_date;
    String primary_stat_type;
    String team_id;
    String active_sw;
    String primary_sport_code;
    String birth_state;
    String weight;
    String name_middle;
    String name_display_roster;
    String end_date;
    ...
    String name_nick;
    String status_code;
    String name_matrilineal;
    String team_name;
    String name_display_last_first;
    String twitter_id;
    String name_title;
    String file_code;
    String name_last;
